...
namespace PolyNES.UI.Views
{
    public class MainMenuView
    {
        ...
        private readonly GameManager _stateManager;
        private readonly IList<string> _roms;

        private int _selectorIndex;

        public MainMenuView(GameManager stateManager, SpriteFont font, KeyboardManager keyboardManager, GraphicsDevice gd)
        {
            _systemFont = font;
            _graphicsDevice = gd;
            _selectorIndex = 20;
